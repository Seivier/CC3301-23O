...
Ud. debe crear el archivo compilar.c y programar ahí lo solicitado.
...
archivo compilar.zip que contiene compilar.c, con su solución,
...
Entregue por U-cursos el archivo compilar.zip

A continuación es muy importante que descargue de U-cursos el mismo
archivo que subió.  Luego examine el archivo compilar.c revisando
